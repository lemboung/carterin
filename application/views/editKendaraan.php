        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <?php echo form_open_multipart('Member/EditPosting');
              foreach ($form as $f) {?>
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <?php	foreach ($data3 as $d3) {
                    if ($i == 0 && $d3["gambar"] != "no image") { ?>
                      <center><br><img src="<?php echo base_url("/images/$d3[gambar]"); ?>" style="height: 100px; width: 100px"><br><small>preview image</small><br></center>
                      <input type="file" id="exampleInputFile" name="gambar">
                      <p class="help-block">ukuran file max 2MB</p>
                      <?php
                    } elseif ($i > 0 && $d3["gambar"] == "no image") { ?>
