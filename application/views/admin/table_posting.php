  ...
  <body class="hold-transition skin-blue sidebar-mini">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>
            Tabel Posting
            <small>Kelola Posting</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
            <li class="active">Kelola Posting</li>
          </ol>
        </section>
        ...
        <section class="content">
          <div class="row">
            <div class="col-xs-12">
                <!-- <a href="<?php echo base_url("")."posting_add"; ?>"><button type="submit" class="btn btn-primary"> + Buat Posting</button></a> -->
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Kelola Posting</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
